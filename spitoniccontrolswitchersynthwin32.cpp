...
static ControlSwitcherExpSynth* global_pSynth;
//static BasicSynth synth;
//static SimpleInstrumentSynth synth;
//static StepSequencerSynth synth;
//static StepSequencerExpSynth* global_pSynth;
//static StepSequencerBufferPlayerExpSynth* global_pSynth;
//static StepSequencerBufferPlayerEffectExpSynth synth;
//static EventsSynth synth;
//static EventsExpSynth* global_pSynth;
//static EventsExpBufferPlayerSynth* global_pSynth;
...
//static BandlimitedOscillatorExpSynth* global_pSynth;
...
//static DelayExpSynth* global_pSynth;
//static FilteredNoiseSynth* global_pSynth;
//static FilterExpSynth synth;
//static FMDroneSynth synth;
//static FMDroneExpSynth* global_pSynth;
//static InputDemoSynth synth;
//static LFNoiseTestSynth synth;
//static ReverbTestSynth synth;
//static SimpleStepSeqSynth* global_pSynth;
//static SimpleStepSequencerBufferPlayerSynth* global_pSynth;
